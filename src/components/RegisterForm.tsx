    ...
    const handleRegister = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            const response = await axios.post(
                `https://shoewizardsdb.azurewebsites.net/docsusers/users?firstname=${firstname}&lastname=${lastname}&address=${address}&email=${email}&username=${username}&password=${password}&phonenumber=${phonenumber}&role=customer`,
            );
                        ...
                        <div className="p-4 space-y-4 md:space-y-6 sm:p-6 w-full">
                            ...
                            >
                                ...
                                <div className="relative z-0 w-full mb-7 group">
                                    ...
                                    />
                                    <label htmlFor="username" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transhtmlForm -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Username</label>
                                </div>
                                <div className="relative z-0 w-full mb-7 group">
                                    <input
                                ...
                                <button
                                    type="submit"
                                    className="w-full text-white bg-shoewizards-medium-blue hover:bg-shoewizards-medium-blue focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm mt-3 px-5 py-2.5 text-center"
                                >
                                    SUBMIT
                                </button>
                            </form>
